...
public class Function
{
    ...
    [Function("Function")]
    public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "generate-sas/{blobName}")] HttpRequestData req, string blobName)
    {
